  ...
  group('UpcomingTransaction', () {
    test('fromJson and toJson should work correctly with all fields', () {
      var upcomingTransaction = UpcomingTransaction(
        ...
        totalOutstandingAmount: AmountValue(
          value: 100.0,
          unit: 'cents',
          currency: 'EUR',
        ),
        minimumDueAmount: AmountValue(
          value: 100.0,
          unit: 'cents',
          currency: 'EUR',
        ),
        outstandingSddrAmount: AmountValue(
          value: 100.0,
          unit: 'cents',
          currency: 'EUR',
        ),
        ...
        gracePeriodInDays: 1,
        dunningFees: AmountValue(value: 100.0, unit: 'cents', currency: 'EUR'),
        otherFees: AmountValue(value: 100.0, unit: 'cents', currency: 'EUR'),
