...
void main() {
  group('ChangeRequestConfirm', () {
    final changeRequestConfirmJson = {'tan': 'test_tan'};
    ...
    test('fromJson creates a ChangeRequestConfirm object from JSON', () {
      final changeRequestConfirmFromJson = ChangeRequestConfirm.fromJson(
        changeRequestConfirmJson,
      );
  ...
  group('ChangeRequestToken', () {
    final changeRequestTokenJson = {'token': 'test_token'};

    final changeRequestToken = ChangeRequestToken(token: 'test_token');

    test('fromJson creates a ChangeRequestToken object from JSON', () {
      final changeRequestTokenFromJson = ChangeRequestToken.fromJson(
        changeRequestTokenJson,
      );
    ...
    test(
      'fromRawJson creates a ChangeRequestToken object from raw JSON string',
      () {
        final rawJson = json.encode(changeRequestTokenJson);
        final changeRequestTokenFromRawJson = changeRequestTokenFromJson(
          rawJson,
        );
    ...
    test(
      'toRawJson creates a raw JSON string from a ChangeRequestToken object',
      () {
    ...
    test('fromJson with empty strings', () {
      final emptyJson = {'tan': '', 'token': ''};

      final changeRequestConfirmEmpty = ChangeRequestConfirm.fromJson(
        emptyJson,
      );
    ...
    test('fromJson with null values should throw TypeError', () {
      final nullJson = {'tan': null, 'token': null};

      expect(
        () => ChangeRequestConfirm.fromJson(nullJson),
        throwsA(isA<TypeError>()),
      );
      expect(
        () => ChangeRequestToken.fromJson(nullJson),
        throwsA(isA<TypeError>()),
      );
    });
    ...
    test('fromJson with unexpected JSON keys should ignore the extra keys', () {
      ...
      final changeRequestConfirmExtra = ChangeRequestConfirm.fromJson(
        extraKeysJson,
      );
      final changeRequestTokenExtra = ChangeRequestToken.fromJson(
        extraKeysJson,
      );
    ...
    test('fromJson with missing JSON keys should throw Error', () {
      ...
      expect(
        () => ChangeRequestConfirm.fromJson(missingKeysJson),
        throwsA(isA<Error>()),
      );
      expect(
        () => ChangeRequestToken.fromJson(missingKeysJson),
        throwsA(isA<Error>()),
      );
    });
  });
  ...
  group('ChangeRequestConfirmed', () {
    test('fromJson with empty strings and null values', () {
      final Map<String, dynamic> emptyResponseBody = {'asd': 'asd'};
      ...
      final changeRequestConfirmedEmpty = ChangeRequestConfirmed.fromJson(
        emptyJson,
      );
    ...
    test('fromJson with unexpected JSON keys should ignore the extra keys', () {
      final extraKeysJson = {
        ...
        'response': {
          ...
          'response_code': 123,
          'id': 'test_id',
          'response_body': {'test_key': 'test_value'},
          'extra_key': 'extra_value',
        },
        'extra_key': 'extra_value',
      };

      final changeRequestConfirmedExtra = ChangeRequestConfirmed.fromJson(
        extraKeysJson,
      );
    ...
    test(
      'fromJson creates a ChangeRequestConfirmed object with a response',
      () {
        final json = {
          'success': true,
          'response': {
        ...
        expect(
          changeRequestConfirmed.response!.responseBody,
          isA<ResponseBody>(),
        );
      },
    );
    ...
    test(
      'toJson creates a JSON object from a ChangeRequestConfirmed object',
      () {
        final json = {
          'success': true,
          'response': {
    ...
    test(
      'fromJson creates a ChangeRequestConfirmed object without a response',
      () {
        final json = {'success': false, 'response': null};
  ...
  group('Response', () {
    ...
    test(
      'fromJson creates a Response object from JSON with a responseBody',
      () {
        final jsonResponse = {
          "status": "test_status",
          "response_code": 123,
