...
void main() {
  group('AuthorizationRequest', () {
    ...
    test('fromJson() creates an AuthorizationRequest object from JSON', () {
      final authRequestFromJson = AuthorizationRequest.fromJson(
        authRequestJson,
      );
      expect(authRequestFromJson, isA<AuthorizationRequest>());
      expect(
        authRequestFromJson.authorizationRequest.id,
        authRequest.authorizationRequest.id,
      );
      expect(
        authRequestFromJson.authorizationRequest.status,
        authRequest.authorizationRequest.status,
      );
      expect(
        authRequestFromJson.authorizationRequest.updatedAt,
    ...
    test(
      'toJson() creates a JSON object from an AuthorizationRequest object',
      () {
        final authRequestToJson = authRequest.toJson();
        expect(authRequestToJson, isA<Map<String, dynamic>>());
        expect(
          authRequestToJson['authorizationRequest'],
          isA<Map<String, dynamic>>(),
        );
        expect(
          authRequestToJson['authorizationRequest']['id'],
          authRequest.authorizationRequest.id,
        );
        expect(
          authRequestToJson['authorizationRequest']['status'],
          authRequest.authorizationRequest.status,
        );
        expect(
          authRequestToJson['authorizationRequest']['updated_at'],
    ...
    test(
      ...
      () {
        ...
        final authRequestFromRawJson = AuthorizationRequest.fromRawJson(
          rawJson,
        );
        expect(authRequestFromRawJson, isA<AuthorizationRequest>());
        expect(
          authRequestFromRawJson.authorizationRequest.id,
          authRequest.authorizationRequest.id,
        );
        expect(
          authRequestFromRawJson.authorizationRequest.status,
          authRequest.authorizationRequest.status,
        );
        expect(
          authRequestFromRawJson.authorizationRequest.updatedAt,
          authRequest.authorizationRequest.updatedAt,
        );
    ...
    test(
      ...
      () {
        ...
        expect(
          decodedJson['authorizationRequest'],
          isA<Map<String, dynamic>>(),
        );
        expect(
          decodedJson['authorizationRequest']['id'],
          authRequest.authorizationRequest.id,
        );
        expect(
          decodedJson['authorizationRequest']['status'],
          authRequest.authorizationRequest.status,
        );
        expect(
          decodedJson['authorizationRequest']['updated_at'],
          authRequest.authorizationRequest.updatedAt.toIso8601String(),
        );
  ...
  group('AuthorizationRequestClass', () {
    ...
    test(
      'fromJson() creates an AuthorizationRequestClass object from JSON',
      () {
        final authRequestFromJson = AuthorizationRequestClass.fromJson(
          authRequestJson,
        );
    ...
    test(
      ...
      () {
        final rawJson = json.encode(authRequestJson);
        final authRequestFromRawJson = AuthorizationRequestClass.fromRawJson(
          rawJson,
        );
