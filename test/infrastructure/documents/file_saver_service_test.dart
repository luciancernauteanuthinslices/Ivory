...
void main() {
  ...
  group('saveFile', () {
    group("android platform", () {
      ...
      test(
        'when the file is saved it should show a success notification',
        () async {
          // given
      ...
      test(
        "when the file can't be saved it should show a failure notification",
        () async {
          // given
          final fileSaverService = FileSaverService();
          fileSaverService.flutterLocalNotificationsPlugin =
      ...
      test(
        "when the file already exists it should show a failure notification",
        () async {
          // given
          final fileSaverService = FileSaverService();
          fileSaverService.flutterLocalNotificationsPlugin =
    ...
    group("iOS platform", () {
      ...
      test("when the file is saved, it should use the share sheet", () async {
        ...
        // then
        final xfiles =
            verify(mockShare.shareXFiles(captureAny)).captured.first
                as List<XFile>;
