...
void main() {
  ...
  test(
    "When asking to fetch account summary it should have a loading state",
    () async {
      //given
      ...
      //then
      expect(
        (await appState).accountSummaryState,
  ...
  test(
    "When fetching account summary fails it should update with error",
    () async {
      //given
      final store = createTestStore(
