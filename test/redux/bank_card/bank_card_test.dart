...
void main() {
  ...
  group("Fetching bank card", () {
    test(
      "When fetching bank card successfully should update with bank card",
      () async {
        // given
    ...
    test(
      "When fetching bank card is failing should update with error",
      () async {
        // given
        final store = createTestStore(
        ...
        // when
        store.dispatch(
          GetBankCardCommandAction(cardId: "", forceReloadCardData: false),
        );
  ...
  group("Activate bank card", () {
    test(
      "When activating bank card successfully should update with bank card",
      () async {
        // given
        final store = createTestStore(
          bankCardService: FakeBankCardService(),
        ...
        // when
        store.dispatch(
          BankCardActivateCommandAction(cardId: "inactive-card-id"),
        );
    ...
    test(
      "When activating bank card is failing should update with error",
      () async {
        // given
        ...
        // when
        store.dispatch(BankCardActivateCommandAction(cardId: ""));
  ...
  group("View card details", () {
    ...
    test(
      ...
      () async {
        ...
        expect((await loadingState).bankCardState, isA<BankCardLoadingState>());
        expect(
          (await appState).bankCardState,
          isA<BankCardDetailsFetchedState>(),
        );
      },
    );

    test(
      "When viewing card details is failing should update with error",
      () async {
        // given
        final store = createTestStore(
          bankCardService: FakeFailingBankCardService(),
  ...
  group("Change pin", () {
    ...
    test(
      ...
      () async {
        ...
        expect(
          (await appState).bankCardState,
          isA<BankCardPinConfirmedState>(),
        );
      },
    );

    test("When change pin fails, should return error", () async {
      //given
      final store = createTestStore(
        bankCardService: FakeFailingBankCardService(),
        deviceService: FakeDeviceService(),
  ...
  group("Freeze/unfreeze card", () {
    test(
      "When freezing card successfully should update with bank card",
      () async {
        // given
        final store = createTestStore(
          bankCardService: FakeBankCardService(),
    ...
    test(
      "  When unfreezing card successfully should update with bank card",
      () async {
        // given
        final store = createTestStore(
          bankCardService: FakeBankCardService(),
    ...
    test(
      "When creating a card is succesfull should update with bank card",
      () async {
        // given
        ...
        // then
        expect(
          (await loadingState).bankCardsState,
          isA<BankCardsLoadingState>(),
        );
