...
void main() {
  ...
  group("Loading credentials", () {
    test(
      ...
      () async {
        ...
        final store = createTestStore(
          ...
          initialState: createAppState(authState: AuthInitialState()),
        );

        final loadingState = store.onChange.firstWhere(
          (element) => element.authState is AuthLoadingState,
        );
    ...
    test(
      ...
      () async {
        ...
        final appState = store.onChange.firstWhere(
          (element) => element.authState is AuthInitialState,
        );
  ...
  group("Init Authentication", () {
    test(
      "Should authenticate the user without bound device succesfully",
      () async {
        final Map<String, Object> values = <String, Object>{
          'deviceId': '',
          'email': 'email',
        ...
        expect((await loadingState).authState, isA<AuthLoadingState>());
        expect(
          (await appState).authState,
          isA<AuthenticationInitializedState>(),
        );
        expect(
    ...
    test("Should authenticate the user with bound device succesfully", () async {
      ...
      expect(
        ((await appState).authState as AuthenticationInitializedState).authType,
    ...
    test(
      ...
      () async {
        ...
        expect(
          ((await appState).authState as AuthErrorState).errorType,
  ...
  group("Authenticate", () {
    test(
      ...
      () async {
        ...
        expect(
          ((await appState).authState as AuthenticatedState).authType,
          equals(AuthType.withBiometrics),
        );
      },
    );
