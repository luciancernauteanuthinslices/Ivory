...
void main() {
  ...
  test(
    "When using the reset command the state should reset to initial",
    () async {
      // given
      final store = createTestStore(
        ...
        initialState: createAppState(
          notificationState: NotificationTransactionApprovalState(
            message: message,
          ),
        ),
      );
      ...
      // then
      expect(
        (await appState).notificationState,
        isA<NotificationInitialState>(),
      );
    },
  );
  ...
  group("Receiving a notification", () {
    test(
      ...
      () async {
        ...
        expect(
          (await transactionApprovalState).transactionApprovalState,
