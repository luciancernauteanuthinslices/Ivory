...
class OnboardingRepaymentOptionScreen extends StatefulWidget {
  ...
  @override
  State<OnboardingRepaymentOptionScreen> createState() =>
      _OnboardingRepaymentOptionScreenState();
}

class _OnboardingRepaymentOptionScreenState
    extends State<OnboardingRepaymentOptionScreen> {
  @override
...
class OnboardingRepaymentOptionPageContent extends StatefulWidget {
  ...
  @override
  State<OnboardingRepaymentOptionPageContent> createState() =>
      _OnboardingRepaymentOptionPageContentState();
}

class _OnboardingRepaymentOptionPageContentState
    extends State<OnboardingRepaymentOptionPageContent> {
  ...
  void initState() {
    ...
    inputFixedRateController.addListener(() {
      if (inputFixedRateController.text.isNotEmpty) {
        ...
        if (double.parse(inputFixedRateController.text) < minFixedRate &&
            chosenPercentageRate < 10) {
          chosenFixedRate = minFixedRate;
        } else if (double.parse(inputFixedRateController.text) >=
                minFixedRate &&
            chosenPercentageRate < 10) {
  ...
  Widget build(BuildContext context) {
    ...
    return Expanded(
      child: Column(
        children: [
          ChooseRepaymentType(
            repaymentType: (initialPercentageRate >= 10)
