...
class Person {
  ...
  factory Person.fromJson(Map<String, dynamic> json) => Person(
    ...
    ownEconomicInterestSignedAt: json["own_economic_interest_signed_at"] == null
        ? null
    ...
    internationalOperativityExpectation:
        ...
        ? []
        : List<String>.from(
            json["international_operativity_expectation"]!.map((x) => x),
          ),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "terms_conditions_signed_at": termsConditionsSignedAt?.toIso8601String(),
    "own_economic_interest_signed_at": ownEconomicInterestSignedAt
        ?.toIso8601String(),
...
class CreatePersonResponse {
  ...
  CreatePersonResponse({required this.personId});

  factory CreatePersonResponse.fromJson(Map<String, dynamic> json) =>
      CreatePersonResponse(personId: json["person_id"]);

  Map<String, dynamic> toJson() => {"person_id": personId};
}
...
class CreateKycReqBody {
  ...
  CreateKycReqBody({required this.method, required this.deviceData});

  factory CreateKycReqBody.fromJson(Map<String, dynamic> json) =>
      CreateKycReqBody(method: json["method"], deviceData: json["device_data"]);
