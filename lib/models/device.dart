...
enum DeviceBindingKeyPurposeType { restricted, unrestricted }

enum DeviceBindingLanguageType { en, de, fr }
...
class SmsChallenge {
  ...
  SmsChallenge({required this.appSignature});

  Map<String, dynamic> toJson() => {"app_signature": appSignature};
}
...
class CreateDeviceBindingChallenge {
  ...
  CreateDeviceBindingChallenge({required this.id, required this.challenge});
...
class Device {
  ...
  factory Device.fromJson(Map<String, dynamic> json) =>
      Device(deviceId: json['id'], deviceName: json['name']);
}
