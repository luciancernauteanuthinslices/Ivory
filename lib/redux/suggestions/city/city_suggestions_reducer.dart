...
CitySuggestionsState citySuggestionsReducer(
    CitySuggestionsState state, dynamic action) {
  if (action is CitySuggestionsLoadingEventAction) {
    ...
    return CitySuggestionsFetchedState(
        cities: action.cities, searchTerm: action.searchTerm);
  } else if (action is FetchCitySuggestionsFailedEventAction) {
    return CitySuggestionsErrorState(
        errorType: action.errorType, searchTerm: action.searchTerm);
  }
