...
import 'package:solarisdemo/redux/top_up/add_card_reducer.dart';
...
AppState appReducer(AppState currentState, dynamic action) {
  return AppState(
    ...
    referenceAccountState: referenceAccountReducer(
      currentState.referenceAccountState,
      action,
    ),
    personAccountState: personAccountReducer(
      currentState.personAccountState,
      action,
    ),
    ...
    deviceBindingState: deviceBindingState(
      currentState.deviceBindingState,
      action,
    ),
