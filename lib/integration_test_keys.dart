...
class LoginPage{
  ...
  final passwordTextFieldForMobileTab = const Key("PasswordTextFieldForMobileTab");
  final mobileNumberPrefixDropdown = const Key("MobileNumberPrefixDropdown");
  final mobileNumberPrefixSearchField = const Key("mobileNumberPrefixSearchField");
