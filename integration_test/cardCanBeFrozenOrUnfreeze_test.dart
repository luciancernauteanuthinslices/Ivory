...
void main() {
  patrolTest(
    'Check if virtual card can be frozen and unfrozen',
    ...
    ($) async {
      ...
      if (targetCardFound && activeCardFound) {
        ...
        print(
          '⚠️  Card 6368 not found or not active, using another active card',
        );
      }

      // Ensure the freeze button is visible and ready
      await $.waitUntilVisible(
        $(keys.cardActions.freezeCardButton),
