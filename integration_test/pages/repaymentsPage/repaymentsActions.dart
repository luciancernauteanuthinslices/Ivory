...
class RepaymentsActions{
   ...
   PatrolFinder get setRepaymentReminder => $(Icons.notifications_active_outlined);
   ...
   Future<void> tapChangeRepaymentRate() async {await changeRepaymentRate.tap();}
   Future<void> tapSetRepaymentReminder() async {await setRepaymentReminder.tap();}
   Future<void> tapViewBills() async {await viewBills.tap();}
   Future<void> tapRepaymentAnalytics() async {await repaymentAnalytics.tap();}
   Future<void> tapNeedMoreCredit() async {await needMoreCredit.tap();}
}